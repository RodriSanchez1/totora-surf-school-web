    ...
    <footer className="bg-totora-dark text-white pt-16 pb-8 border-t border-white/5">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="space-y-6">
            ...
            <div className="flex space-x-4">
              <a href="#" className="bg-white/10 p-2 rounded-full hover:bg-totora-yellow hover:text-totora-dark transition-all">
                <Facebook size={20} />
              </a>
              <a href="#" className="bg-white/10 p-2 rounded-full hover:bg-totora-yellow hover:text-totora-dark transition-all">
                <Instagram size={20} />
          ...
          <div>
            ...
            <ul className="space-y-3">
              {NAVIGATION_LINKS.map(link => (
                <li key={link.id}>
                  <Link to={link.href} className="text-gray-300 hover:text-white hover:translate-x-1 transition-all inline-block">
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3 text-gray-300">
                <MapPin className="flex-shrink-0 mt-1 text-totora-light" size={18} />
          ...
          <div>
            ...
            <Button href={BOOKING_URL} variant="primary" fullWidth className="font-bold">
        ...
        <div className="border-t border-white/10 pt-8 text-center text-gray-400 text-sm">
          <p>&copy; {new Date().getFullYear()} <FormattedMessage id="footer.rights" /></p>
        </div>
      </div>
    </footer>
  );
