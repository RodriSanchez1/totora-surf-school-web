  ...
  <div className="group relative overflow-hidden rounded-2xl shadow-lg transition-all duration-300 hover:shadow-2xl h-96">
    ...
    <div className="absolute inset-0">
      <img
        ...
        loading="lazy"
      />
      <div className="absolute inset-0 bg-gradient-to-t from-totora-dark via-totora-dark/50 to-transparent opacity-80 group-hover:opacity-70 transition-opacity"></div>
    </div>
